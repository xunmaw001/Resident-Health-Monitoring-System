...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
    ...
    <block v-for="(item,index) in newsList" :key="index">
        ...
        <view @tap="onDetailTap('news',item.id)" v-if="index>0" class="list-item"
            ...
            <view
                    :style='{"padding":"20rpx ","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(255,0,0,0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0 0 2rpx 0","width":"100%","lineHeight":"auto","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{item.newsName}}
            </view>
        </view>
    </block>
...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1.0)","borderRadius":"30rpx 30rpx 0px 0px","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"solid  solid none solid"}'>
    ...
    <view class="right-content" @tap="onPageTap('kepuzhishi')" :style="{fontSize:'32rpx',color:'rgba(255, 255, 255, 1.0)'}">
        查看更多
    </view>
</view>
<view class="list-box style3"
    ...
    <view @tap="onDetailTap('kepuzhishi',product.id)" v-for="(product,index) in kepuzhishiList"
        ...
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"100rpx","borderWidth":"10rpx","width":"200rpx","borderStyle":"solid","height":"200rpx"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+product.kepuzhishiPhoto"></image>
        <view class="list-item-body"
            ...
            <view
                    ...
                    class="list-item-title hide1">{{product.kepuzhishiName}}
            </view>
            <view v-if="product.kepuzhishiNewMoney"
                  :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"red","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"68rpx","fontSize":"34rpx","borderStyle":"solid"}'
                  class="list-item-title">￥{{product.kepuzhishiNewMoney}}
            </view>
            <view v-else-if="product.kepuzhishiValue"
                  :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"68rpx","fontSize":"28rpx","borderStyle":"solid"}'
                  class="list-item-title">{{product.kepuzhishiValue}}
            </view>
        </view>
    </view>
</view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let kepuzhishi = await this.$api.list('kepuzhishi', {
                page: 1,
                limit: 6,
                });

            this.kepuzhishiList = kepuzhishi.data.list
            this.kepuzhishiList.forEach(function(item, index) {
                if(item.kepuzhishiContent != null && item.kepuzhishiContent != "" && item.kepuzhishiContent != "null"){
                    item.kepuzhishiContent =item.kepuzhishiContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
