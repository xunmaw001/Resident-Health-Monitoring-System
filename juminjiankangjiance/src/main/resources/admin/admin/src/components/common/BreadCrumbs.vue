<template>
  <el-breadcrumb class="app-breadcrumb" separator="(●'◡'●)" style="height:50px;backgroundColor:var(--publicMainColor);borderRadius:0px;padding:0px 20px 0px 20px;boxShadow:4px 4px 2px var(--publicSubColor);borderWidth:0px;borderStyle:dotted solid double dashed;borderColor:var(--publicSubColor);">
