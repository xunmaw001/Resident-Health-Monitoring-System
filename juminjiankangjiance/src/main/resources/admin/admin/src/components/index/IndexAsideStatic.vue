  ...
  <el-aside class="index-aside" height="100vh" width="250px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:var(--publicSubColor)">
        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="var(--publicSubColor)" text-color="#ffffff" active-text-color="#EEF749" default-active="0">
