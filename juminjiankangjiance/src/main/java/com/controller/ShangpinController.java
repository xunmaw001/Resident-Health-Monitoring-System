...
public class ShangpinController {
    ...
    @Autowired
    private ShangpinLiuyanService shangpinLiuyanService;//科普留言
    @Autowired
    ...
    */
    ...
    public R save(@RequestBody ShangpinEntity shangpin, HttpServletRequest request){
        ...
        Wrapper<ShangpinEntity> queryWrapper = new EntityWrapper<ShangpinEntity>()
            ...
            .eq("shangpin_vidoe", shangpin.getShangpinVidoe())
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ShangpinEntity shangpinEntity = new ShangpinEntity();
//                            shangpinEntity.setShangpinName(data.get(0));                    //标题 要改的
//                            shangpinEntity.setShangpinPhoto("");//详情和图片
//                            shangpinEntity.setShangpinTypes(Integer.valueOf(data.get(0)));   //科普类型 要改的
//                            shangpinEntity.setShangpinVidoe(data.get(0));                    //科普视频 要改的
...
//                            shangpinEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R gexingtuijian(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        PageUtils pageUtils = shangpinCollectionService.queryPage(params1);
        List<ShangpinCollectionView> collectionViewsList =(List<ShangpinCollectionView>)pageUtils.getList();
        Map<Integer,Integer> typeMap=new HashMap<>();//购买的类型list
        for(ShangpinCollectionView collectionView:collectionViewsList){
            Integer shangpinTypes = collectionView.getShangpinTypes();
