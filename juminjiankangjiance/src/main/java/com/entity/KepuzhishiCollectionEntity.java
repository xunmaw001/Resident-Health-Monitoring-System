...
public class KepuzhishiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KepuzhishiCollectionEntity() {

	}

	public KepuzhishiCollectionEntity(T t) {
		try {
