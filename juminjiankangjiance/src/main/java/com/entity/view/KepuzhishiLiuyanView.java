...
public class KepuzhishiLiuyanView extends KepuzhishiLiuyanEntity implements Serializable {
	...
	public KepuzhishiLiuyanView() {

	}

	public KepuzhishiLiuyanView(KepuzhishiLiuyanEntity kepuzhishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, kepuzhishiLiuyanEntity);
