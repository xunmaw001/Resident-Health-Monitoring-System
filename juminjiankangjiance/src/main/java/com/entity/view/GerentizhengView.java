...
public class GerentizhengView extends GerentizhengEntity implements Serializable {
	...
	* 身体质量的值
	*/
	@ColumnInfo(comment="身体质量的字典表值",type="varchar(200)")
	private String gerentizhengValue;
	...
	* 获取： 身体质量的值
	*/
	public String getGerentizhengValue() {
		return gerentizhengValue;
	}
	/**
	* 设置： 身体质量的值
	*/
	public void setGerentizhengValue(String gerentizhengValue) {
		this.gerentizhengValue = gerentizhengValue;
	}
	...
	public String toString() {
		return "GerentizhengView{" +
			", gerentizhengValue=" + gerentizhengValue +
